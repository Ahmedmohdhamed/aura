...
gdjs.evtsExt__CameraShake__StartShaking.conditionTrue_0 = {val:false};
gdjs.evtsExt__CameraShake__StartShaking.condition0IsTrue_0 = {val:false};
...
}{runtimeScene.getVariables().get("__CameraShake").getChild("Duration").setNumber(1234567890);
}{runtimeScene.getVariables().get("__CameraShake").getChild("StartEaseDuration").setNumber((typeof eventsFunctionContext !== 'undefined' ? Number(eventsFunctionContext.getArgument("EaseDuration")) || 0 : 0));
}}
